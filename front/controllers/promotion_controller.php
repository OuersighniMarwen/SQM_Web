<?php
  class promotionController {
    ...
    {
      require_once"models/classe_promotion.php";
      require_once"models/produitt.php";
      require_once"connexion.php";
      $proID=$_GET['proID'];
      $produits = promotion::afficheProduit($proID);
      $pourcent = $_GET['propourcentage'];

     require_once("views/produit/produitenpromo.php");
    }
 ...
 require_once"modals/classe_promotion.php";
    ...
    public function proaff() {
      ...
      require_once('views/promotion/proaff.php');
    }

...
static public function envoie_mail($email = 'chiheb.berrich@esprit.tn', $body = null)
 {
...
public static function affecterPromo($id,$ref)
{
   ...
   foreach($client as $client){
      self::envoie_mail($client->email, 'Bonjour nous avons...');
   }
   */
}
...
public static function afficheProduit($proID){
    ...
    $req="SELECT * FROM produit WHERE IDpromotion='" .$proID."' ";
     $produit = config::getInstance()->conn->query($req);
